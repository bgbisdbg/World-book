...
class Book(models.Model):
    ...
    genre = models.ForeignKey('Genre', on_delete=models.CASCADE, help_text='Выберите жанар книги',
...
class Status(models.Model):
    name = models.CharField(max_length=20, help_text='Введите статус книги', verbose_name='Статус экземпляра книги')
...
class BookInstance(models.Model):
    ...
    inv_nom = models.CharField(max_length=20, null=True, help_text='Введите инвентарный номер экземпляра',
                               verbose_name='Инвернтарный номер')
